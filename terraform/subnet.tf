# Shared route table for the public subnets
...
# Define public subnets in the shared VPC
...
# Define private subnets in the shared VPC
...
# Associate the public route table with the prod public subnets
...
# Define a route table for the prod private subnets
...
# Associate the private route table with the prod private subnets
