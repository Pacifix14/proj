# Get the latest ECS-optimized Amazon Linux 2 AMI for ARM64
...
# Define scaling policy to scale up the Auto Scaling Group
...
# Define scaling policy to scale down the Auto Scaling Group
...
# Create CloudWatch alarm to trigger scale up policy on high CPU utilization
...
# Create CloudWatch alarm to trigger scale down policy on low CPU utilization
